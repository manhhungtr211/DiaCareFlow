# UC-011: Tìm kiếm và trích xuất nội dung web (XNG Search & Scrape)

## Metadata
- **ID:** UC-011-xng-search
- **Status:** draft
- **Owner:** Hùng
- **Source:** UC-000-web-tools.md (v2, 2026-07-14)
- **Last updated:** 2026-07-15

## Actor
- **Người dùng**: Người có nhu cầu hỏi thông tin thực tế từ web.

## Trigger
- Người dùng gửi một câu hỏi hoặc từ khóa cần tìm kiếm thông tin trên web.
...
4. Hệ thống tiến hành chấm điểm và ranking 5 URL này dựa trên tổng hợp các yếu tố: độ uy tín tên miền, path_boost (độ sâu URL), tần suất (freq) và đánh giá jina.
...
## History
- v1 (2026-07-14, Hùng): Initial draft (as UC-000-web-tools).
- v2 (2026-07-14, Refactored): Thêm thuật toán ranking vào Notes, bổ sung AC-2 và AC-3 để test luồng tính điểm.
- v3 (2026-07-15, speckit-plan): Promoted to UC-011-xng-search with formal spec.md.
